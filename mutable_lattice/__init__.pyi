...
def relations_among_c(vectors: list[Vector], /) -> Lattice:
    ...

def relations_among_with_decomposition(vectors: list[Vector], /) -> Lattice:
    ...

def decompose_relations_among(vectors: list[Vector], /) -> tuple[list[Vector], list[Vector], list[list[Vector]]]:
    ...
